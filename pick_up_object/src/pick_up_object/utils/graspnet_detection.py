...
MODEL_PATH = os.path.join(rospkg.RosPack().get_path('pick_up_object'), 'src/pick_up_object/utils/robocup.weights')
print(MODEL_PATH, rospkg.RosPack().get_path('pick_up_object'))
